...
export default function PropertyMainContent({
  ...
  return (
    <>
      ...
      {item.description && (
        <div className="bg-white rounded-2xl px-4 py-3 shadow-sm">
          <h2 className="font-display font-700 text-base mb-3">Описание</h2>
        ...
        {sent ? (
          ...
          <form onSubmit={onSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            ...
            <button type="submit" disabled={sending || !captcha?.passed}
              className="sm:col-span-2 w-full btn-orange py-2.5 rounded-xl font-semibold font-display disabled:opacity-50 text-sm shadow-sm">
