...
export const empty: Partial<Listing> = {
  ...
  use_watermark: true, export_yandex: false, export_avito: false, export_cian: false, export_other: true, export_youla: false, export_domclick: false,
