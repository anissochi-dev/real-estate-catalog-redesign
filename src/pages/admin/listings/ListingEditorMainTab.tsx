  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        ...
        <div {...errWrap('deal')}>
          <label className="flex items-center gap-1.5 text-xs text-muted-foreground mb-1">
            <span className="w-5 h-5 rounded-full bg-emerald-100 flex items-center justify-center flex-shrink-0"><Icon name="Handshake" size={11} className="text-emerald-600" /></span>Тип сделки *
          </label>
        ...
        <div {...errWrap('condition')}>
          <label className="flex items-center gap-1.5 text-xs text-muted-foreground mb-1">
            <span className="w-5 h-5 rounded-full bg-amber-100 flex items-center justify-center flex-shrink-0"><Icon name="Star" size={11} className="text-amber-500" /></span>Состояние *
          </label>
      ...
      <div>
        <label className="flex items-center gap-1.5 text-xs text-muted-foreground">
          <span className="w-5 h-5 rounded-full bg-violet-100 flex items-center justify-center flex-shrink-0"><Icon name="Target" size={11} className="text-violet-600" /></span>Назначение (можно выбрать несколько, максимум {MAX_PURPOSES})
        ...
        <div className="border-t border-border pt-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div {...errWrap('owner_name')}>
              <label className="flex items-center gap-1.5 text-xs text-muted-foreground mb-1">
                <span className="w-5 h-5 rounded-full bg-blue-100 flex items-center justify-center flex-shrink-0"><Icon name="User" size={11} className="text-brand-blue" /></span>Имя {canEditPhone ? '*' : ''}
              </label>
              <input
            ...
            <div {...errWrap('owner_phone')}>
              <label className="flex items-center gap-1.5 text-xs text-muted-foreground mb-1">
                <span className="w-5 h-5 rounded-full bg-emerald-100 flex items-center justify-center flex-shrink-0"><Icon name="Phone" size={11} className="text-emerald-600" /></span>Телефон {canEditPhone ? '*' : ''}
              </label>
              <PhonePickerInput
