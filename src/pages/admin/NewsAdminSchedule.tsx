  ...
  return (
    <div className="bg-white rounded-2xl border border-border p-6 max-w-2xl space-y-5">
      ...
      <div className="text-sm text-muted-foreground">
        Копирайтер ищет свежие бизнес-новости региона (а если их нет — берёт тему из каталога) и раз в сутки публикует одну глубокую аналитическую статью на основе реальных источников (без выдумывания фактов).
      </div>
