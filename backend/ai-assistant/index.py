...
SYSTEM_PROMPTS = {
    'describe': (
        ...
        'От собственника\n'
        'Первая строка раздела: «От собственника! Без комиссий и %» — всегда.\n\n'
        ...
        'Собственник, документы готовы, прямая продажа без цепочек. Возможные бонусы: рассрочка и т.д.\n\n'
        'Призыв к действию\n'
        ...
        'ВАЖНЫЕ ПРАВИЛА:\n'
        '- Заголовки разделов пиши ТОЧНО как указано выше, на отдельной строке, без двоеточий, без markdown, без * и #.\n'
