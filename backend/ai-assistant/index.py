...
SYSTEM_PROMPTS = {
    'describe': (
        ...
        '- В самом начале описания ОБЯЗАТЕЛЬНО используй УТП: «От собственника! Без комиссий и %».\n'
        ...
        'ЖЁСТКАЯ СТРУКТУРА (соблюдай неукоснительно, каждый раздел с заголовком):\n\n'
        '1. ОБЩИЕ ПАРАМЕТРЫ И НАЗНАЧЕНИЕ\n'
        '- Тип объекта, текущее состояние, под какие виды деятельности идеально подходит (с аргументацией на основе характеристик и локации).\n\n'
        '2. ЛОКАЦИЯ И РАЙОН\n'
        ...
        '- Парковка.\n'
        '- Состояние отделки: если "под чистовую" — свобода дизайна и экономия на демонтаже; если готовая — старт "завтра".\n\n'
        '4. КОММУНИКАЦИИ\n'
        '- Электричество: мощность, стабильность.\n'
        '- Водоснабжение и канализация.\n'
        '- Отопление, вентиляция.\n'
        '- Связь: интернет-провайдеры.\n'
        '(только на основе данных карточки, пустые поля пропускать)\n\n'
        '5. ФИНАНСОВЫЕ ПЕРСПЕКТИВЫ И ДОХОДНОСТЬ\n'
        '- Если есть арендный доход — детализируй: ставка, сроки, надёжность.\n'
        '- Расчётная доходность: при наличии данных укажи % годовых и срок окупаемости.\n'
        '- Драйверы увеличения дохода: перепрофилирование, дробление, повышение ставки.\n\n'
        '6. УСЛОВИЯ И ЮРИДИЧЕСКАЯ ЧИСТОТА\n'
        '- Собственник, документы готовы, прямая продажа без цепочек.\n'
        '- Возможные бонусы: быстрый выход на сделку, рассрочка.\n\n'
        '7. ПРИЗЫВ К ДЕЙСТВИЮ (CALL TO ACTION)\n'
        '- Убедительная фраза, стимулирующая немедленное действие. Ограниченность предложения.\n'
        '- Добавить "Торг уместен" или "Только для решительных инвесторов" по контексту.\n\n'
        'ВАЖНЫЕ ПРАВИЛА:\n'
        ...
        '- Не используй markdown, символы * и #. Заголовки разделов выделяй заглавными буквами или с двоеточием.\n'
        '- Объём — строго не более 3000 символов. Описание должно быть детализированным, но укладываться в лимит.'
    ),
    'title': (
