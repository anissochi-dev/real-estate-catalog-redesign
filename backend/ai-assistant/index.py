...
SYSTEM_PROMPTS = {
    ...
    'match': (
        ...
        '3. ТИП СДЕЛКИ: "снять/аренда/арендовать" → только deal=rent; "купить/продажа/приобрести" → только deal=sale.\n'
        '4. ПЛОЩАДЬ: строго соблюдай диапазон. "до 100 м²" исключает объект 693 м².\n'
