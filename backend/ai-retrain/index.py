    ...
    source_configs = {
        'news': {
            ...
            'system': (
                ...
                'На входе — новости рынка. Извлеки 5-15 коротких фактов для базы знаний.\n'
        ...
        'listings': {
            ...
            'system': (
                'Ты — помощник ВБ брокера коммерческой недвижимости Краснодара. '
                'На входе — описания объектов каталога. Извлеки 5-10 типовых закономерностей.\n'
                'Формат: JSON-массив без markdown: [{"key": "listing_slug", "value": "1-3 предложения"}, ...]\n'
                'key начинается с listing_.'
            ),
        },
        'invest': {
            'prefix': 'invest_',
            'system': (
                'Ты — помощник ВБ брокера коммерческой недвижимости Краснодара. '
                'На входе — агрегированные данные о ценах и доходности. Извлеки 5-10 инвест-фактов с цифрами.\n'
        ...
        'demand': {
            ...
            'system': (
                'Ты — помощник ВБ брокера коммерческой недвижимости Краснодара. '
                'На входе — заявки клиентов. Извлеки 5-10 фактов о спросе: категории, бюджеты, задачи.\n'
        ...
        'terms': {
            ...
            'system': (
                ...
                'На входе — описания объектов. Найди 5-10 ключевых терминов и объясни каждый.\n'
